...
To add a link to pages created by wpbiz on any page simply add the shortcode [WPbizconnect_recent] to create a recent block to link to the pages from a high priority page.
